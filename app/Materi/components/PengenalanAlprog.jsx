    ...
    return (
        <div className="w-full my-4 space-y-2 ">
            <Typography variant="lead" className="text-justify indent-8">
                <span className="font-bold"> Algoritma</span> adalah serangkaian langkah-langkah logis dan sistematis yang digunakan untuk menyelesaikan suatu masalah. Algoritma menjadi dasar utama dalam pemrograman karena membantu programmer memahami dan memecahkan masalah sebelum diimplementasikan ke dalam kode.
            </Typography>
            ...
            <ul className="list-decimal pl-12 space-y-2 text-lg">
